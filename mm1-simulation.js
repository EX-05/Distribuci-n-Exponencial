...
mm1Container.style.cssText = 'width: 15vw; height: 10vh; position: absolute; top: 10px; left: 10px; z-index: 100; background: rgba(0, 0, 0, 0.5); border: 1px solid #ff007a; border-radius: 8px;';
...
renderer.domElement.style.display = 'block'; // Ensure renderer is visible
renderer.domElement.style.opacity = '1'; // Ensure renderer is not hidden
...
camera.position.z = 5;
function animateMM1() { 
    requestAnimationFrame(animateMM1); 
    TWEEN.update(); 
